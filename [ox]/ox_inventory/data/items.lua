...
["bobby_pin"] = {
	...
	["thelostmc_first_flag"] = {
		label = "The Lost MC First Flag",
		weight = 500,
		stack = true,
		close = true,
		description = "The Lost MC First Flag",
		client = {
			image = "thelostmc_flag.png",
		}
	},

	["thelostmc_flag"] = {
		label = "The Lost MC Flag",
		weight = 500,
		stack = true,
		close = true,
		description = "The Lost MC Flag",
		client = {
			image = "thelostmc_flag.png",
		}
	},
