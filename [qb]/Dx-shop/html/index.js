...
window.addEventListener('message', function(event) {
    ...
    if (ed.action === "openShop") {
        ...
        ed.basket.forEach(function(data, index) {
            totalBasketPrice += data.totalPrice;
            document.getElementById("total-price").innerHTML = "$" + totalBasketPrice;
            var basketHTML = `
            <div class="cart-item">
                <div class="cart-img">
                <img src="nui://ox_inventory/web/images/${data.name}.png" alt="">
                </div>
    ...
    if (name1 === "shopItems") {
        ...
        cData[name2].forEach(function(data, index) {
            ...
            <div class="item">
                ...
                <img class="img" src="nui://ox_inventory/web/images/${data.name}.png" alt="">
                <div class="itemalt">
        ...
        cData[name2].forEach(function(data, index) {
            ...
            <div class="job-item">
                ...
                <img class="job-img" src="nui://ox_inventory/web/images/${data.name}.png" alt="">
