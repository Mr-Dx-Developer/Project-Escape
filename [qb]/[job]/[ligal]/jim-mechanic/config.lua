Config = {
	...
	Main = { -- Main variables
		...
		JobRoles = { "urbanmechanic", "countymechanic" }, -- These are the job roles who can use items if RequiresJob is enabled.
	...
	Emergency = {
		...
		Locations = {
			{ coords = vec4(435.7, -973.21, 25.7, 180), prop = true, }, -- MRPD UNDERGROUND PARKING
	...
	NOS = { -- NOS STUF
		...
		NosRefillCharge = 350000, 	-- amount in dollars required to refill a nos can
