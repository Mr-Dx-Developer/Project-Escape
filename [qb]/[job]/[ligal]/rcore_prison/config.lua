Config = {
    Debug = true,               -- This is enabling debug of rcore_prison 
    ...
    Dispatch = DispatchList.PS,                 -- [NONE - Standalone, RCORE - rcore_dispatch, PS - ps_dispatch, QS - qs_dispatch, CORE - core_dispatch, CD - cd_dispatch, DUSA - dusa_dispatch, REDUTZU - redutzu-mdt, LOVE_SCRIPTS - emergencydispatch, ORIGEN - origen_police] 
