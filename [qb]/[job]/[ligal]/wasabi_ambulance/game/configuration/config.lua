...
Config.Locations = {
    Pillbox = {
        RespawnPoint = { -- When player dies and bleeds out; they will revive at nearest hospital; Define the coords of this hospital here.
            coords = vec3(-676.2239, 315.7681, 89.6145),
            heading = 350.6260,
        ...
        Blip = {
            Enabled = true,
            Coords = vec3(-674.05, 324.23, 83.08),
            Sprite = 61,
            Color = 2,
            Scale = 1.0,
        ...
        clockInAndOut = {
            ...
            coords = vec3(-681.88, 329.27, 83.08), -- Location of where to go on and off duty(If not using target)
            ...
            target = {
                ...
                coords = vec3(-681.88, 329.27, 83.08),
                heading = 85.00,
                width = 2.0,
                length = 3.0,
                minZ = 82.08 - 0.9,
        ...
        PersonalLocker = {
            ...
            coords = vec(-675.62, 338.63, 83.08),   -- Location of where to access personal locker (If target is disabled)
            ...
            target = {
                enabled = true,                    -- If enabled, the location and distance above will be obsolete
                label = 'Access Locker',
                coords = vector3(-675.62, 338.63, 83.08),
                heading = 85.00,
                width = 2.0,
                length = 3.0,
                minZ = 82.08 - 0.9,
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            Ped = 's_m_m_scientist_01',                  -- Check in ped
            Coords = vec3(-676.63, 325.87, 83.08 - 0.9), -- Coords of ped
            Distance = 4.85,                             -- Distance to show textUI (If target is not enabled below)
            Heading = 15.00,                             -- Heading of ped
            ...
            Target = {
                enabled = true,                          -- Enable Target? (Can be customized in wasabi_bridge/customize/cl_customize.lua the target system)
                label = 'Check In',
                coords = vec3(-676.63, 325.87, 83.08),
                heading = 15.00,
                distance = 5.0,
                width = 2.0,
                length = 4.0,
            ...
            RespawnNoBedLocation = { coords = vec3(-676.2239, 315.7681, 89.6145), heading = 350.6260 }, -- Coords and heading of where to spawn player if DisableHospitalBeds is set to true or beds are full
            HospitalBeds = {
                --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
                { coords = vec3(-676.2239, 315.7681, 89.6145 + 0.3), heading = 350.6260 },
                { coords = vec3(-671.5546, 315.2676, 89.6145 + 0.3), heading = 350.6260 },
                { coords = vec3(-667.1478, 314.8641, 89.6145 + 0.3),  heading = 350.6260 },
                { coords = vec3(-681.1454, 320.1375, 89.6145 + 0.3), heading = 267.5633 },
                { coords = vec3(-680.7033, 324.8643, 89.6145 + 0.3), heading = 267.5633 },
        ...
        MedicalSupplies = {                                                     -- EMS Shop for supplies
            ...
            Coords = vec3(-673.15, 338.47, 83.08),                       -- Coords of ped/target
            Heading = 265.00,                                                   -- Heading of ped
            Supplies = {                                                        -- Supplies
                ...
                { item = 'medikit', label = 'Medikit', price = 100 },
            }
        },
