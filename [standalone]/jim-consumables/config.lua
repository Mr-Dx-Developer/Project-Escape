...
Config = {
	...
	Consumables = {
		...
		["ifaks"] = { 			emote = "coffee", 		time = math.random(5000, 6000), stress = math.random(24, 45), heal = 10, armor = 0, type = "drug", stats = { effect = "heal", amount = 6, widepupils = false, canOD = false } },
